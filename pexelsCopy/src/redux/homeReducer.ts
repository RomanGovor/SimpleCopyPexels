...
export const actions = {
  ...
  asyncSetHeaderPhoto: () => ({ type: ASYNC_MAIN_UPDATE_HEADER_PHOTO } as const),
  ...
  setCuratedPageIndex: (page: number) => ({ type: 'MAIN/SET_CURATED_PAGE_INDEX', page } as const),
};
