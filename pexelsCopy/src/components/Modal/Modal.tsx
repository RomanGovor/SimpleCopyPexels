                ...
                <div className={'nav-level'}>
                    <div className={'nav-level__left'}>
                        <div className={'nav-level__item mt10'}>
                            <button onClick={onCloseClick} className={'rd__button rd__button--text rd__button--circle-icon'}>
                    ...
                    <div className={'nav-level__right'}></div>
                </div>
            </div>
            <div className={'modal__overlay'}>
                <button onClick={onCloseClick} className={'modal__exit rd__button rd__button--text-white rd__button--circle-icon'}>
                    <i className={'rd__svg-icon svg-icon'}>
                        <img src={closeSvg}/>
                    </i>
                </button>
                <div className={'modal__content'}>
                    <div className={'photo-page'}>
                                            ...
                                            <div className={'nav-level__item'}>
                                                <a className={'photo-page__mini-profile'} href={photo.phLink} target={'_blank'}>
                                                    <div className={'photo-page__mini-profile__avatar rd__avatar rd__avatar--large'}>
                                                        <img height={'50'} width={'50'} src={photo.phPhotoLink}></img>
                                                    </div>
                                    ...
                                    <div className={'nav-level__item photo-page__action-buttons-level-item'}>
                                        <div className={'rd__button-group photo-page__action-buttons'}>
                                            <button onClick={onLikeBtnClick} data-photoId={photo.photoId} className={'js-like js-photo-page-action-buttons-like rd__button rd__button--white rd__button--with-icon-left'}>
                                                ...
                                                {!isLiked && <i className={'rd__button--like--not-active--icon svg-icon'}>
                                                    <img src={heartIcon}/>
                                                </i>
                                                }
                                            </button>
                        ...
                        <section className={'photo-page__section photo-page__section--photo-details'}>
                            ...
                            <p className={'photo-page__photo-details-overview__description'}></p>
                        </section>
                    </div>
                </div>
            </div>
