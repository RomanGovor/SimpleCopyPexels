...
const NavList: React.FC<PropsType> = ({ vocabulary, lang }) => {
  ...
  const onBurgerClick = (event: any) => {
    ...
    if (target?.getAttribute('data-type') === 'burger') {
      if (isOpenOverlay) setOpenOverlay(false);
  ...
  return (
    <>
      <ul className="sub-nav" onClick={onBurgerClick}>
        ...
        <li className="hide-button mt05 hide-nav-item">
          <div className="rd__dropdown">
            <a className="sub-nav__item">
              <i>
                <img alt="triple-icon" src={tripleSvg} />
              </i>
            </a>
        ...
        <NavListItem
          link="https://www.pexels.com/onboarding/"
        ...
        <div className={`sub-nav__overlay ${isOpenOverlay && 'sub-nav__overlay--open'}`}>
          ...
          <ul className="sub-nav__overlay__icons">
            <OverlayListItem
              ...
              isIcon
              link="https://www.facebook.com/pexels"
            />
            <OverlayListItem
              title="twitter"
              iconClass="fa-twitter"
              isIcon
              link="https://twitter.com/pexels"
            />
            <OverlayListItem
              title="instagram"
              iconClass="fa-instagram"
              isIcon
              link="https://www.instagram.com/pexels/"
            />
            <OverlayListItem
              title="pinterest"
              iconClass="fa-pinterest-p"
              isIcon
              link="https://www.pinterest.com/pexels/"
            />
            <OverlayListItem
              title="youtube"
              iconClass="fa-youtube-play"
              isIcon
              link="https://www.youtube.com/channel/UC7bU8qGV5Zh6PJrUaFQNoxg"
            />
          </ul>
        </div>
      </ul>
